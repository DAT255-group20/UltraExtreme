...
public class SpriteFactory {
	...
	public SpriteFactory(SimpleBaseGameActivity activity) {
		...
		TextureRegion playerShip = BitmapTextureAtlasTextureRegionFactory.createFromAsset(
				textureAtlas, activity, "ship_placeholder.png", 0, 0);
        textureMap.put(ObjectName.PLAYERSHIP, playerShip);
        
        TextureRegion playerBullet = BitmapTextureAtlasTextureRegionFactory.createFromAsset(
        		textureAtlas, activity, "bullet_placeholder.png", 40, 0);
        textureMap.put(ObjectName.BASIC_BULLET, playerBullet);
        
        TextureRegion BasicEnemy = BitmapTextureAtlasTextureRegionFactory.createFromAsset(
        		textureAtlas, activity, "enemy_placeholder.png", 0, 40);
	  ...
	  */
	public GameObjectSprite getNewSprite(AbstractEntity entity, VertexBufferObjectManager vbom) {
		textureMap.get(entity.getObjectName());
		return new GameObjectSprite(entity, vbom, textureMap.get(entity.getObjectName()));
	}
}
