...
public class Dimension {
	...
	public Vector2d getQuotient(Dimension otherDimension) {
		return new Vector2d(this.getX()/otherDimension.getX(), 
				this.getY()/otherDimension.getY());
	}
	
	/**
	 * Scales the given position in the given dimension to 
	 * a position of this dimension.
	 * 
	 * @param otherDimension
	 ...
	 */
	public Position scalePosition(Dimension otherDimension, Position otherPosition) {
