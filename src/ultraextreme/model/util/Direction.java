...
public enum Direction {
	...
	/**
	 * For example, if the x-value is to become the
	 * y-value, the xToYMod will be 1. Or if x value
	 * is to be negated, xToXMod will be -1.
	 * 
	 * @param xToXMod
	 ...
	 */
	private Direction(double xToXMod, double yToYMod, double xToYMod, double yToXMod) {
