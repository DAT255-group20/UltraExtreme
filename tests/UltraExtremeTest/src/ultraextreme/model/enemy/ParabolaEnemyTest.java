...
public class ParabolaEnemyTest extends TestCase {	
	...
	public void testUpdate1() {
		...
		ParabolaEnemy enemy = new ParabolaEnemy(
				startPos, midPos, endPos, ObjectName.BASIC_WEAPON);
	...
	public void testUpdate2() {
		...
		ParabolaEnemy enemy = new ParabolaEnemy(
				startPos, midPos, endPos, ObjectName.SPINNING_WEAPON);
		boolean yWasNegative = false;
		boolean yWasPositive = false;
	...
	public void testException() {
		...
		try {
			new ParabolaEnemy(startPos, midPos, endPos, ObjectName.SPINNING_WEAPON);
